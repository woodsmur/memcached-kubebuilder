...
import (
	...
	memcachedv1 "example.com/memcached-kubebuilder/api/v1"
...
// +kubebuilder:rbac:groups=memcached.example.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=memcached.example.com,resources=memcacheds/status,verbs=get;update;patch
